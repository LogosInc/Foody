...
import com.example.foody.util.Constants.Companion.DEFAUT_RECIPES_NUMBER
...
class RecipesViewModel @ViewModelInject constructor(
    ...
    fun saveMeatAndDietType(mealType: String, mealTypeId: Int, dietType: String, dietTypeId: Int) =
    ...
    fun applyQueries(): HashMap<String, String>{
        ...
        queries[QUERY_NUMBER] = DEFAUT_RECIPES_NUMBER
